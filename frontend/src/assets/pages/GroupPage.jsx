    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 py-8">
                                ...
                                <tr key={group.id} className="border-t">
                                    ...
                                    <td className="py-2 px-4">
                                        <button
                                            ...
                                            className="bg-black text-white rounded-xl p-2 hover:bg-stone-700 cursor-pointer mr-3 transition"
                                        >
                                            Редактировать
                                        </button>
                                        <button
                                            onClick={() => handleDelete(group.id, group.name)}
                                            className="bg-red-600 text-white hover:bg-red-800 p-2 rounded-xl cursor-pointer transition"
                                        >
                                            Удалить
                                        </button>
                                    </td>
                ...
                {isModalOpen && (
                    <div
                        className="fixed inset-0 bg-black/20 backdrop-blur-sm transition-opacity flex items-center justify-center z-50">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-end gap-2">
                                    <button
                                        ...
                                        className="px-4 py-2 text-stone-700 hover:bg-gray-100 transition rounded-md cursor-pointer"
                                    >
                                        Отмена
                                    </button>
                                    <button
                                        type="submit"
                                        className="px-4 py-2 bg-black text-white rounded-md cursor-pointer transition hover:bg-stone-700"
                                    >
